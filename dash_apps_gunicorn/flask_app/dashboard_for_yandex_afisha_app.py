...
def init_dash(server):
    ...
    dashboard_for_yandex_afisha_app = dash.Dash(__name__, server=server, url_base_pathname='/api/dashboard_for_yandex_afisha/', external_stylesheets=[dbc.themes.SANDSTONE, dbc_css])
